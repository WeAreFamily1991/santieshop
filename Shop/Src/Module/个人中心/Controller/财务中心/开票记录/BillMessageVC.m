...
//    NSMutableArray *childVCs = [[NSMutableArray alloc]init];
    ...
    self.pageContentView = [[FSPageContentView alloc]initWithFrame:CGRectMake(0,120, SCREEN_WIDTH,SCREEN_HEIGHT-DRTopHeight-120) childVCs:self.childVCs parentVC:self delegate:self];
