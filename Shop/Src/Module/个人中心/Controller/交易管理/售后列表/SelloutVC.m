...
//    [backView addSubview:searchBtn];
     UIView *backView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH,45)];
        ...
        backIMG.userInteractionEnabled =YES;
        [backView addSubview:backIMG];
        self.orderTF =[[UITextField alloc]initWithFrame:CGRectMake(WScale(40), 0, SCREEN_WIDTH-WScale(60), WScale(45))];
    ...
    //    searchBtn.backgroundColor =REDCOLOR;
        ...
        searchBtn.frame =CGRectMake(SCREEN_WIDTH-WScale(40),0, WScale(30), WScale(45));
        [searchBtn addTarget:self action:@selector(searchBtnClick:) forControlEvents:UIControlEventTouchUpInside];
        [backView addSubview:searchBtn];
}
