...
-(void)addsegentView
{
    ...
    self.titleView = [[FSSegmentTitleView2 alloc]initWithFrame:CGRectMake(0,0,SCREEN_WIDTH,0) delegate:self indicatorType:0];
    ...
    self.pageContentView = [[FSPageContentView2 alloc]initWithFrame:CGRectMake(0,0, SCREEN_WIDTH,SCREEN_HEIGHT-DRTopHeight-0) childVCs:childVCs parentVC:self delegate:self];
