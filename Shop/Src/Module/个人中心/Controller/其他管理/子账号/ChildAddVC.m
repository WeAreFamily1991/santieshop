...
//        NSMutableDictionary *dic =[NSMutableDictionary dictionaryWithObject:@[,,,,,,] forKey:@[]];
        NSDictionary *dic =@{@"accountName":self.nameTF.text,@"mobilePhone":self.phoneTF.text,@"account":self.phoneTF.text,@"password":[self.passwordTF.text MD5],@"status":[NSString stringWithFormat:@"%d",self.lockBtn.selected],@"id":self.childModel.child_id,@"buyerid":self.childModel.buyerid,@"parentid":self.childModel.parentid};
